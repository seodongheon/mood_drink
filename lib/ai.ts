...
[안주 큐레이션 다양성 원칙]
- 매번 무겁고 기름진 음식만 추천하지 말고, **밤에 먹어도 속이 편안하고 가벼운 안주(예: 명란구이와 오이 슬라이스, 바질 방울토마토 마리네이드, 먹태구이와 땡초마요, 버터 갈릭 풋콩(에다마메), 구운 브리치즈와 견과류/꿀, 그릭요거트 그래놀라, 카나페, 샤베트 등)**도 적극적으로 다양하게 추천하세요.
